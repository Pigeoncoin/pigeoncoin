...
enum
{
    pigeonconsensus_SCRIPT_FLAGS_VERIFY_NONE                = 0,
    pigeonconsensus_SCRIPT_FLAGS_VERIFY_P2SH                = (1U << 0), // evaluate P2SH (BIP16) subscripts
    pigeonconsensus_SCRIPT_FLAGS_VERIFY_DERSIG              = (1U << 2), // enforce strict DER (BIP66) compliance
...
EXPORT_SYMBOL unsigned int pigeonconsensus_version();
