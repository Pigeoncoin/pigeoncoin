/* src/config/pigeon-config.h.  Generated from pigeon-config.h.in by configure.  */
/* src/config/pigeon-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Pigeon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Pigeon Core"
...
#define PACKAGE_BUGREPORT "https://github.com/Pigeoncoin/pigeoncoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Pigeon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Pigeon Core 0.14.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pigeoncore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://pigeoncoin.org/"
