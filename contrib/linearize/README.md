# Linearize
Construct a linear, no-fork, best version of the Pigeon blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install pigeon_hash

https://github.com/pigeonpay/pigeon_hash
...
JSON-RPC server. Running `pigeond` or `pigeon-qt -server` will be sufficient.
...
* `input`: pigeond blocks/ directory containing blkNNNNN.dat
